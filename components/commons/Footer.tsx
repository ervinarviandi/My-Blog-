    ...
    <div className='w-full'>
      <hr className='border border-dashed border-1 ' />
        <div className='lg:max-w-7xl mx-auto px-5 py-2'>
          <p className='text-center dark:text-gray-400 text-gray-700'>Ervin Blog © 2024 </p>
          <div className='flex justify-center items-center gap-2'>
          <p className='text-center dark:text-gray-400 text-gray-700'>Diterbitkan dengan </p>
